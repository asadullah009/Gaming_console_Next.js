        ...
        <Box mt={2}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={4}>
              ...
              <TextField type='date' variant='outlined' fullWidth margin='normal'sx={{
              backgroundColor: '#fff',borderRadius:"5px"
            }} />
            </Grid>
            <Grid item xs={12} sm={4}>
            ...
            <DialogContent>
              ...
              >
                ...
                <Stack sx={{ width: '50%' }} spacing={2}>
                  <Alert
                    ...
                    severity='info'
                  >
                    Need a Hand? Checkout the organizer
                  </Alert>
                </Stack>
              </Box>
              <Box
              ...
              >
                ...
                <FormControl fullWidth margin='normal'>
                  <RadioGroup value={participationType} onChange={e => setParticipationType(e.target.value)}>
                    <Box
                      sx={{
                        display: 'flex',
                        flexDirection: 'row',
