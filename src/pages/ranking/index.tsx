    ...
    <>
      ...
      >
        ...
        <Dialog open={openDialog} onClose={cancelEdit}>
          ...
          >
            <TextField label='Rank' fullWidth margin='normal' value={rank} onChange={e => setRank(e.target.value)} />

            <Select label='Participant' fullWidth value={participant} onChange={e => setParticipant(e.target.value)}>
        ...
        <Typography variant='h6' gutterBottom sx={{ padding: '16px',color:"#fff" }}>
          Results List
        </Typography>
        <Box
          sx={{
...
FinalResultsPage.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>
