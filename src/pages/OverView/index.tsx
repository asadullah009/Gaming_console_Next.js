    ...
    <>
      ...
      >
        ...
        <Box mb={2} sx={{}}>
          ...
          >
            <CardContent>
              <Typography variant='h4' sx={{ borderBottom: '.1px solid #fff', color:'#fff' }}>
                Tournament Name
              </Typography>
              ...
              <Typography variant='body2' sx={{  color:'#fff' }}>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Non ad consequatur quos delectus ex in officia
                quia molestias quasi hic. Quam sit similique tempora reprehenderit aut corporis eius autem enim? Lorem,
                ipsum dolor sit amet consectetur adipisicing elit. Praesentium, esse temporibus commodi corrupti
                doloribus culpa suscipit vero veritatis dolorem debitis sequi vel recusandae, alias consectetur deleniti
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={4}>
            <Card sx={{ borderLeft: '4px solid #45f884',
              ...
              <CardContent>
                <Typography variant='h6' sx={{  color:'#fff' }}>Price</Typography>
                <Typography variant='body2' sx={{  color:'#fff' }}>
                  $50
                </Typography>
              </CardContent>
          ...
          <Grid item xs={12} sm={4}>
            <Card sx={{ borderLeft: '4px solid #45f884', backgroundColor: '#000',
              border:'1px solid #333' }}>
              <CardContent>
                <Typography variant='h6' sx={{  color:'#fff' }}>Fee</Typography>
                <Typography variant='body2' sx={{  color:'#fff' }}>
                  $10
                </Typography>
              </CardContent>
          ...
          <Grid item xs={12} sm={4}>
            <Card sx={{ borderLeft: '4px solid #45f884', backgroundColor: '#000',
              border:'1px solid #333' }}>
              <CardContent>
                <Typography variant='h6' sx={{  color:'#fff' }}>Timing</Typography>
                <Typography variant='body2' sx={{  color:'#fff' }}>
                  12:00 PM
                </Typography>
              </CardContent>
        ...
        <Box mb={2}>
          <Card sx={{
            ...
            <CardContent>
              <Typography variant='h4' sx={{  color:'#fff' }}>Participants</Typography>
              <Box display='flex' justifyContent='space-between' alignItems='center'>
                <div>
                  <Typography variant='h6' sx={{  color:'#fff' }}>
                    Total Participants
                  </Typography>
                  <Typography variant='h3' sx={{  color:'#fff' }}>100</Typography>
                </div>
                <div>
                  <Typography variant='h6' sx={{  color:'#fff' }}>
                    Registered Participants
                  </Typography>
                  <Typography variant='h3' sx={{  color:'#fff' }}>50</Typography>
                </div>
                <div>
        ...
        <Box mb={2}>
          <Card sx={{
            ...
            <CardContent>
              <Typography variant='h4' sx={{  color:'#fff' }}>Winner</Typography>
              <Typography variant='body2' sx={{  color:'#fff' }}>
                Sample Name
              </Typography>
            </CardContent>
...
GameOverview.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>
